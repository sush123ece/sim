...
int main(int argc, char **argv) {
  ...
  logfile.addLogger(sinkLogger);
	...
	Queue pqueue2(SERVICE2, memFromPkt(FEEDER_BUFFER), eventlist,NULL); pqueue2.setName("PQueue2"); logfile.writeName(pqueue2);
	...
	for (int i=0;i<TCP_1;i++){
	  tcpSrc = new TcpSrc(NULL,NULL,eventlist); tcpSrc->setName("stcp1_"+ntoa(i)); logfile.writeName(*tcpSrc);
	  tcpSnk = new TcpSink(); tcpSnk->setName("Tcp1_"+ntoa(i)); logfile.writeName(*tcpSnk);
	...
	for (int i=0;i<TCP_2;i++){
	  tcpSrc = new TcpSrc(NULL,NULL,eventlist); tcpSrc->setName("stcp2_"+ntoa(i)); logfile.writeName(*tcpSrc);
	  tcpSnk = new TcpSink(); tcpSnk->setName("Tcp2_"+ntoa(i)); logfile.writeName(*tcpSnk);
